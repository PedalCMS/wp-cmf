...
trait FieldRenderingTrait {
	 ...
	 */
	protected function render_settings_field_html( FieldInterface $field, string $option_name, string $page_id ): string {
	 ...
	 * @return string Rendered HTML.
	 */
	protected function render_cpt_field_html( FieldInterface $field, int $post_id ): string {
