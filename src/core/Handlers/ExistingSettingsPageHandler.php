...
class ExistingSettingsPageHandler extends AbstractHandler {
	 ...
	 */
	private const WORDPRESS_PAGES = array(
		'general'    => 'general',
		'writing'    => 'writing',
		'reading'    => 'reading',
	 ...
	 * @return void
	 */
	private function register_single_field( string $page_id, string $option_group, FieldInterface $field ): void {
	 ...
	 * @return void
	 */
	private function register_group_section( string $page_id, string $option_group, FieldInterface $field ): void {
