 ...
 */
class New_Post_Type_Handler extends Abstract_Handler {
	...
	public function add_post_type( string $post_type, array $args ): self {
		$this->post_types[ $post_type ] = Custom_Post_Type::from_array( $post_type, $args );
		return $this;
	}

	/**
	 * Add a Custom_Post_Type instance
	 *
	 * @param Custom_Post_Type $cpt Custom_Post_Type instance.
	 * @return self
	 */
	public function add_post_type_instance( Custom_Post_Type $cpt ): self {
	 ...
	 *
	 * @return array<string, Custom_Post_Type>
	 */
	...
	private function register_post_type_meta_boxes( string $post_type ): void {
		...
		// Register Metabox_Field containers as meta boxes
		$registered_ids = [];
	...
	/**
	 * Render a Metabox_Field container
	 *
