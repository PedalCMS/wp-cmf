 ...
 *
 * Manages field registration for existing WordPress taxonomies
 * like 'category', 'post_tag', or any other registered taxonomy.
 */
class Existing_Taxonomy_Handler extends Abstract_Handler {
	...
	public function register_taxonomy_fields(): void {
		foreach ( $this->fields as $taxonomy => $fields ) {
			...
			// Verify this is actually an existing taxonomy
